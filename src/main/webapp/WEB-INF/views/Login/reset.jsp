                        ...
                        >
                            <div class="mb-3">
                                ...
                                <input
                                        ...
                                        required
                                />
                                <p class="txtError" ng-hide="resetPW.email11.$valid">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                        ...
                                        autofocus
                                />
                                <p class="txtError" ng-hide="resetPW.password1.$valid">
                                    Mời bạn nhập password cũ!
                                </p>
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                        ...
                                        required
                                />
                                <p class="txtError" ng-hide="resetPW.password_confirm2.$valid">
