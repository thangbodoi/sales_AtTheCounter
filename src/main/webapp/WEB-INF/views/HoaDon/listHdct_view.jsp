...
<section>
    <div class="container" style="width: 1200px">
        <form:form method="POST" action="/user/hoaDon/updateHoaDon/${hoadon.id}" modelAttribute="hoadon">
            <div class="row mt-4">
                <div class="col-6">
                    <label>Mã</label>
            ...
            <div class="row mt-4">
                ...
                <div class="col-6">
                    ...
                    <label style="font-size: 30px">${hoadon.idKH.ten}</label> ID:
                    <form:input path="idKH" readonly="true" ></form:input>
                </div>
            </div>
            <div class="row mt-4">
                ...
                <div class="col-6">
                    ...
                    <form:input type="date" class="form-control" path="ngayThanhToan"  readonly="true"></form:input>
                    <form:errors path="ngayThanhToan" cssStyle="color: red"></form:errors>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-6">
                    ...
                    <form:radiobutton path="tinhTrang" value="0" label="Chưa thanh toán" disabled="true"></form:radiobutton>
                    <form:radiobutton path="tinhTrang" value="1" label="Đã thanh toán" disabled="true"></form:radiobutton>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-6">
                    <label>Thành tiền:
                        <div style="color: red;font-size: 30px"> ${totalAmount}</div>
                    </label>
                </div>
            </div>
            ...
            <div class="buttonAdd">
                ...
                <form:button type="submit"
                             class="btn btn-primary btn-info">Thanh Toan</form:button> </c:if>
            </div>
            <div class="buttonBack col-6" style="text-align: right">
                <a type="button" href="/user/hoaDon/listHoaDon" class="btn btn-secondary">Back</a>
            </div>
        </form:form>
    </div>
</section>
