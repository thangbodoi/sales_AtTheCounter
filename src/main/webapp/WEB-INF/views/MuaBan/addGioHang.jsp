...
<body>
<h1 style="text-align: center">Add Gio Hang</h1>
<div class="createForm container" style="width: 1200px;">

    <form:form method="POST" action="/user/purchase/createGioHang" modelAttribute="giohang">
        <div class="row mb-3">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <form:select class="form-select" path="idKH">
                    <form:options items="${listKh}" itemValue="id" itemLabel="ma"></form:options>
                </form:select>
                <form:errors path="idKH" cssStyle="color: red"> </form:errors>
            </div>
        </div>
        <br>
        <div class="row">
        <div class="buttonAdd col-6">
            <button type="submit" class="btn btn-primary btn-success">Add</button>
        </div>
        <div class="buttonBack col-6" style="text-align: right" >
            <a type="button" href="/user/purchase/danhSachGioHang" class="btn btn-secondary">Back</a>
        </div>
        </div>
